...
const attrib_bytes =     [4,4, 1,1,4, 4,4, 1,1,1,4 , 1 ,4]
const attrib_sizes =     [3,2, 4,4,3, 3,1, 1,1,1,3 , 1 ,3] // counts really
const attrib_normalize = [false,false, true,true,false, true,0, 0,1,0,0, 0, ,0]
...
THREE.DualGridGeometryBuffer = DualGeometryBuffer;

function DualGeometryBuffer() {
    var buffer = {};
    ...
    buffer.in_Modulous = new Float32Array( [] );
...
//	}
    ...
    buffer.addFace = function( a,b,c, n, i ){
        ...
        if( n instanceof Array && n[0] instanceof Array ) {
            ...
            a = this.copyPoint( a, n, face_i, i );
            b = this.copyPoint( b, n, face_j, i );
            c = this.copyPoint( c, n, face_k, i );
        }
