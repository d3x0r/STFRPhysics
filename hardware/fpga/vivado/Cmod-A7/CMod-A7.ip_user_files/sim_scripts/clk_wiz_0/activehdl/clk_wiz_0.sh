...
#
# Script generated by Vivado on Thu Jan 18 22:50:16 -0800 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="M:/javascript/carWars/dual-quat/STFRPhysics/hardware/fpga/vivado/Cmod-A7/CMod-A7.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
