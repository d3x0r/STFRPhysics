...
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets design_1_i/ClockBlock/COUNTER_0/latchLock11]
...
create_clock -period 25 [get_ports shield_13_12[0]]
create_clock -period 25 [get_ports shield_13_12[1]]
#create_clock -period  [get_nets design_1_i/ClockBlock/COUNTER_0/iLatch1]
#create_clock -period 2 [get_nets design_1_i/ClockBlock/COUNTER_0/iLatch2]

create_clock -period 6 [get_nets -regexp design_1_i/ClockBlock/COUNTER_0/inst/p_0_in0_in.* ]
create_clock -period 25 [get_nets -regexp design_1_i/ClockBlock/COUNTER_0/inst/wPhase.* ]
...
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { iCLK }]; #IO_L11P_T1_SRCC_35 Sch=ck_a[3]
...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { oCLK }]; #IO_L6P_T0_34 Sch=ck_a[5]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { shield_13_12[0] }]; #IO_L11P_T1_SRCC_34 Sch=ck_io[0]
...
#set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { shield_13_12[1] }]; #IO_L11N_T1_SRCC_35 Sch=ck_io[37]
...
set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS33 } [get_ports { shield_13_12[1] }]; #IO_L14P_T2_SRCC_34 Sch=user_dio[3]
