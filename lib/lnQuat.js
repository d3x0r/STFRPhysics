...
let twisting = false;
class lnQuat{
	w = 0; // unused, was angle of axis-angle, then was length of angles(nL)...
	x = 0;  // these could become wrap counters....
	y = 0;  // total rotation each x,y,z axis.
	z = 0;
	...
	s = 0;  // sin(composite theta)
	qw = 1; // cos(composite theta)
	nL = 1; // normal Linear
	nR = 1; // normal Rectangular
	refresh = null;
	dirty = true; // whether update() has to do work.

        constructor( theta, d, a, b ) {
