...
//                let val = valArr[0]>valArr[1]?(Math.cos(Math.PI/2*(valArr[0]))+1)/2:(Math.cos(Math.PI/2*(2+valArr[0]/valArr[1]))+1)/2;
//                let val = valArr[0]>valArr[1]?(((2-valArr[1]/valArr[0]))/2):(((valArr[0]/valArr[1]))/2);
                let val = valArr[0]>valArr[1]?(valArr[0]):(1-valArr[1]);
                 val = (-Math.cos( valArr[0] * 2*Math.PI/2)+1)/2;
