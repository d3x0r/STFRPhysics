...
*Companion paper:* *Homogeneous Light Propagation Framework* (reserved DOI: 10.5281/zenodo.18997960)
...
This vocabulary lets later papers describe lensing, perihelion behavior, and related effects as consequences of displaced admissible transport and its local realization.
...
The paper does not attempt the governing field equation for displacement, a full treatment of non-collinear transport, or a complete account of lensing, perihelion, or strong-field structure. Those belong to later papers.
...
[1] J. Buckeyne, *Homogeneous Light Propagation Framework*, reserved DOI: 10.5281/zenodo.18997960.

[2] National Institute of Standards and Technology, *Fundamental Physical Constants*.
