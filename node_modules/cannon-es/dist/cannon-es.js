...
class Body extends EventTarget {
  ...
  applyImpulse(impulse, relativePoint) {
    ...
    console.log("Adding velocity  (is):", this.angularVelocity);
  }
  /**
  ...
  integrate(dt, quatNormalize, quatNormalizeFast) {
    ...
    console.log("new velocity (was):", this.angularVelocity);
    ...
    console.log("new velocity (is):", this.angularVelocity); // Use new velocity  - leap frog
    ...
    if (Neq !== 0) {
      ...
      for (iter = 0; iter !== maxIter; iter++) {
        ...
        for (let j = 0; j !== Neq; j++) {
          ...
          console.log("lambda was now: wlambda", deltalambda, watch); // Clamp if we are not within the min/max interval
          ...
          console.log("lambda is now: wlambda", watch);
      ...
      for (let i = 0; i !== Nbodies; i++) {
        ...
        console.log("lambda velocity (was):", b.angularVelocity, b.wlambda);
        b.vlambda.vmul(b.linearFactor, b.vlambda);
        v.vadd(b.vlambda, v);
        b.wlambda.vmul(b.angularFactor, b.wlambda);
        w.vadd(b.wlambda, w);
        console.log("lambda velocity (is):", b.angularVelocity);
