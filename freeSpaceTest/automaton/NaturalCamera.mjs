...
//import * as pf from "./three.js/personalFill.mjs"

const NaturalControls = function ( object, domElement ) {
	var self = this;
	this.object = object;
...
NaturalControls.prototype = Object.create( THREE.EventDispatcher.prototype );

export {NaturalControls};
